...
#define MIMXRT6XX_1st_FLEXSPI_INSTANCE      (0)
#define MIMXRT6XX_1st_FLEXSPI_BASE          (0x40134000u)
#define MIMXRT6XX_1st_FLEXSPI_AMBA_BASE     (0x08000000)

#define MIMXRT6XX_2nd_FLEXSPI_INSTANCE      (1)
#define MIMXRT6XX_2nd_FLEXSPI_BASE          (0x0)
#define MIMXRT6XX_2nd_FLEXSPI_AMBA_BASE     (0x0)

//!@brief FlexSPI Memory Configuration Block
typedef struct _FlexSPIConfig_imxrt6xx
{
...
} flexspi_mem_config_imxrt6xx_t;

/*
 *  Serial NOR configuration block
 */
typedef struct _flexspi_nor_config_imxrt6xx
{
    flexspi_mem_config_imxrt6xx_t memConfig; //!< Common memory configuration info via FlexSPI
...
} flexspi_nor_config_imxrt6xx_t;

/*
 * Serial NOR Configuration Option
 */
typedef struct _serial_nor_config_option_imxrt6xx
{
    union
    {
        struct
...
} serial_nor_config_option_imxrt6xx_t;
