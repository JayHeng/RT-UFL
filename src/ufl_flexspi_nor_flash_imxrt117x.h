...
#ifndef _UFL_FLEXSPI_NOR_FLASH_IMXRT117X_H_
#define _UFL_FLEXSPI_NOR_FLASH_IMXRT117X_H_
...
#define MIMXRT117X_1st_FLEXSPI_INSTANCE      (1)
#define MIMXRT117X_1st_FLEXSPI_BASE          (0x400CC000u)
#define MIMXRT117X_1st_FLEXSPI_AMBA_BASE     (0x30000000U)

#define MIMXRT117X_2nd_FLEXSPI_INSTANCE      (2)
#define MIMXRT117X_2nd_FLEXSPI_BASE          (0x400D0000u)
#define MIMXRT117X_2nd_FLEXSPI_AMBA_BASE     (0x60000000U)

//!@brief FlexSPI Memory Configuration Block
typedef struct _FlexSPIConfig_imxrt117x
{
...
} flexspi_mem_config_imxrt117x_t;

/*
 *  Serial NOR configuration block
 */
typedef struct _flexspi_nor_config_imxrt117x
{
    flexspi_mem_config_imxrt117x_t memConfig; //!< Common memory configuration info via FlexSPI
...
} flexspi_nor_config_imxrt117x_t;

/*
 * Serial NOR Configuration Option
 */
typedef struct _serial_nor_config_option_imxrt117x
{
    union
    {
        struct
...
} serial_nor_config_option_imxrt117x_t;
...
typedef struct _flexspi_nor_flash_driver_imxrt117x
{
    ...
    status_t (*wait_busy)(uint32_t instance, void *config, bool isParallelMode, uint32_t address);
...
#endif /* _UFL_FLEXSPI_NOR_FLASH_IMXRT117X_H_ */
