...
#ifndef __UFL_FLEXSPI_NOR_FLASH_H__
#define __UFL_FLEXSPI_NOR_FLASH_H__
...
status_t flexspi_nor_drv_restore_spi_protocol(uint32_t instance,
                                          flexspi_nor_config_t *config,
...
#endif // __UFL_FLEXSPI_NOR_FLASH_H__
