...
#ifndef _UFL_FLEXSPI_NOR_FLASH_IMXRT118X_H_
#define _UFL_FLEXSPI_NOR_FLASH_IMXRT118X_H_
...
#define MIMXRT118X_1st_FLEXSPI_INSTANCE      (1)
#define MIMXRT118X_1st_FLEXSPI_BASE          (0x525E0000u)
#define MIMXRT118X_1st_FLEXSPI_AMBA_BASE     (0x28000000U)
#define MIMXRT118X_1st_FLEXSPI_ALIAS_BASE    (0x12000000U)

#define MIMXRT118X_2nd_FLEXSPI_INSTANCE      (2)
#define MIMXRT118X_2nd_FLEXSPI_BASE          (0x545E0000u)
#define MIMXRT118X_2nd_FLEXSPI_AMBA_BASE     (0x04000000U)
#define MIMXRT118X_2nd_FLEXSPI_ALIAS_BASE    (0x22000000U)

//!@brief FlexSPI Memory Configuration Block
typedef struct _FlexSPIConfig_imxrt118x
{
...
} flexspi_mem_config_imxrt118x_t;

/*
 *  Serial NOR configuration block
 */
typedef struct _flexspi_nor_config_imxrt118x
{
    flexspi_mem_config_imxrt118x_t memConfig; //!< Common memory configuration info via FlexSPI
...
} flexspi_nor_config_imxrt118x_t;

/*
 * Serial NOR Configuration Option
 */
typedef struct _serial_nor_config_option_imxrt118x
{
    union
    {
        struct
...
} serial_nor_config_option_imxrt118x_t;

typedef struct _flexspi_nor_flash_driver_imxrt118x
{
    uint32_t version;
    ...
    status_t (*partial_program)(uint32_t instance, flexspi_nor_config_t *config, uint32_t dst_addr, const uint32_t *src, uint32_t lengthInBytes);
} flexspi_nor_flash_driver_imxrt118x_t;
...
#endif /* _UFL_FLEXSPI_NOR_FLASH_IMXRT118X_H_ */
