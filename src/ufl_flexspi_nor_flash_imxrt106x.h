...
} flexspi_mem_config_imxrt106x_t;

/*
 *  Serial NOR configuration block
 */
typedef struct _flexspi_nor_config_imxrt106x
{
    flexspi_mem_config_imxrt106x_t memConfig; //!< Common memory configuration info via FlexSPI
...
} flexspi_nor_config_imxrt106x_t;

/*
 * Serial NOR Configuration Option
 */
typedef struct _serial_nor_config_option_imxrt106x
{
    union
    {
        struct
...
} serial_nor_config_option_imxrt106x_t;
